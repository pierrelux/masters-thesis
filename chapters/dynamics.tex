...
\cite{Courtois1977} also dedicated a book topic in the field of queuing theory. The control problem of Markov chains
with such structure was considered in \cite{Teneketzis1980, Delebecque1981,
Phillips1981, Coderch1983} building upon the Courtois' work. This approach treats the \textit{slower} inter-cluster transitions as
